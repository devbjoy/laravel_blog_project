                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Title" value="{{ $slider->title }}">
                                        ...
                                        <div class="mb-3">
                                           ...
                                           <img src="{{ asset('storage/'.$slider->slider_image) }}" alt="" style="width: 80px;height: 80px;">    
                                        </div>
                                        <div class="mb-3">
                                            <label for="slider_img" class="form-label">Slider Description</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="publish" id="" class="form-control @error('publish') is-invalid @enderror">
                                                <option {{ $slider->publish == 'Yes' ? 'selected' : '' }} value="Yes">Yes</option>
                                                <option {{ $slider->publish == 'No' ? 'selected' : '' }} value="No">No</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="show_home" id="" class="form-control @error('show_home') is-invalid @enderror">
                                                <option {{ $slider->show_homepage == 'Yes' ? 'selected' : '' }} value="Yes">Yes</option>
                                                <option {{ $slider->status == 'No' ? 'selected' : '' }} value="No">No</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="category" id="category" class="form-control">
                                                ...
                                                <option {{ $category->id == $slider->category_id ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->name }}</option>
                                              @endforeach
                                               @endif 
                                            </select>
                                            @error('category')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="tags[]" id="tags" class="form-control" multiple>
                                                @if ($tags->isNotEmpty())
                                                    @foreach ($tags as $tag)
                                                        <option {{ in_array($tag->id, array_column($slider->tags->toArray(),'id')) ? 'selected' : '' }} value="{{ $tag->id }}">{{ $tag->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
